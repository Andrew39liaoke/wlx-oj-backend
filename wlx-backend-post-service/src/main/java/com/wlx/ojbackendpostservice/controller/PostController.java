...
public class PostController {
    ...
    public ResponseEntity<Long> save(@Valid @RequestBody @Parameter(description = "帖子") PostAddRequest req,
    ...
    public ResponseEntity<Boolean> update(@Valid @RequestBody @Parameter(description = "帖子") PostUpdateRequest req,
                                          HttpServletRequest request) {
    ...
    public ResponseEntity<Page<PostVO>> pageSelf(@RequestBody PostQueryRequest req, HttpServletRequest request) {
        User loginUser = userFeignClient.getLoginUser(request.getHeader(JwtUtil.HEADER));
        return Result.success(postService.getMyPostVOPage(req, loginUser));
    }
